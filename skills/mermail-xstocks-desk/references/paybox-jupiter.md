...
Do not call `paybox_request_swap`, `paybox_use_plugin`, `jupiter_place_solana_order`, a host Jupiter API, transfers, or x402 payments to purchase an xStock. Use only `xstocks_preview_buy` followed by an explicitly approved `xstocks_submit_buy`.
