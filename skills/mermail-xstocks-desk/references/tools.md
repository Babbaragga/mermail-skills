...
- Preview accepts `productId`, `credentialId`, `amountUsdc`, and optional `slippageBps` up to 50.
- Submit accepts only `previewId`, `approvalToken`, and `idempotencyKey`. It does not accept mint, amount, network, wallet, or slippage overrides.
